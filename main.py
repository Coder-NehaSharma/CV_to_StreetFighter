...
def get_dictionaries(current_dir):
    ...
    for i in list(string.ascii_letters + string.digits) + [
        ...
        image_dict["font " + i] = font_texture(font_type, i, (255, 255, 255))
...
class GameObject:
    def __init__(self,pose_worker=None):
        ...
        self.selected_characters = ["SF3/DrDoom", "SF3/IronMan"]
    ...
    def Input_device_available(self):
        ...
        for i in range(keyboard_conut):
            # Player 1: CV (External)
            self.input_device_list = [InputDevice(self, 1, 1, "external", pose_worker=self.pose_worker)]
        
        # Player 2: Keyboard
        self.input_device_list.append(InputDevice(self, 2, 0, "keyboard"))
        
        # Optional: Add Joysticks if available (as extra inputs or for P2 override)
        for i in range(joystick_count):
            pass # Currently ignoring joysticks to force Keyboard for P2 as requested
